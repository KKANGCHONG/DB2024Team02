...
public class MedicalStaff extends JFrame {
    ...
    public MedicalStaff() {
    getContentPane().setFont(new Font("HY헤드라인M", Font.PLAIN, 14));
    ...
    this.mainScreen = mainScreen; // 메인 화면 인스턴스 저장
        ...
        label.setFont(new Font("HY헤드라인M", Font.PLAIN, 20)); // 글자 크기 설정
        ...
        table.setFont(new Font("HY헤드라인M", Font.PLAIN, 18)); // 글자 크기 설정
        ...
        backButton.setFont(new Font("HY헤드라인M", Font.PLAIN, 14)); // 폰트 설정
